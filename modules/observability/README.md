...
- 公共契约来源：[`日志、Metrics、Trace 与审计`](../../docs/architecture/LumioGameEngine_Architecture_v1.1.md#12-日志metricstrace-与审计)、[`工具链、测试与可观测性`](../../docs/architecture/LumioGameEngine_Architecture_v1.1.md#15-工具链测试与可观测性)

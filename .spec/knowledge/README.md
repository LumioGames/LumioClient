...
| [`standards/repository-architecture.md`](standards/repository-architecture.md) | 仓库边界与架构契约——客户端状态所有权、复制预测和 Architecture Gate;改连接、Replica 或平台边界前查 |
...
| [`features/replica/replica-world-chat.md`](features/replica/replica-world-chat.md) | 客户端 World 绑定/查询与聊天呈现——改 Client World、Attribute Query 或 UI 聊天窗时查 |
